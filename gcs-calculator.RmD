...
sheet1 <- read_excel("~/THE GUTHRIE CLINIC/General Surgery Research - GCS Trauma Calculator/Master Doc.xlsx",
                     sheet = "Sheet1",
    col_types = c("text", "numeric", "text", 
        ...
        "text", "text", "text", "numeric", 
        "numeric"))
sheet2 <- read_excel("~/THE GUTHRIE CLINIC/General Surgery Research - GCS Trauma Calculator/Master Doc.xlsx",
                     sheet = "Sheet2",
    col_types = c("text", "numeric", "text", 
        "text", "text", "text", "numeric", 
        "text", "text", "text", "text", "text", 
